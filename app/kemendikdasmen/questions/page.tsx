...
import { ArrowLeft, FileQuestion, Plus, Trash2, Edit2, CheckCircle2 } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 bg-purple-700 hover:bg-purple-800 text-white font-bold text-xs py-2.5 px-4 rounded-xl shadow-sm transition-all"
          >
            ...
            <div className="bg-white rounded-3xl p-6 w-full max-w-md shadow-2xl space-y-4">
              ...
              <form onSubmit={handleSave} className="space-y-3">
                ...
                <div className="flex items-center justify-end gap-2 pt-2">
                  ...
                  <button type="submit" className="px-4 py-2 bg-purple-700 text-white text-xs font-bold rounded-xl shadow-md">
                    Simpan Pertanyaan
                  </button>
                </div>
              </form>
        ...
        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 space-y-4">
          <div className="flex items-center justify-between">
            <h2 className="text-base font-extrabold text-slate-800 flex items-center gap-2">
              <FileQuestion className="w-5 h-5 text-purple-600" /> Bank Soal Asesmen RIASEC ({soalList.length} Soal)
            </h2>
          </div>
                ...
                {soalList.length === 0 ? (
                  ...
                  soalList.map((s, idx) => (
                    <tr key={s.id} className="hover:bg-slate-50">
                      ...
                      <td className="p-3 font-black text-purple-700">Tipe {s.aspek}</td>
                      <td className="p-3">
                        <span
