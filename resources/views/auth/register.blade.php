...
<head>
    ...
    <title>Pilih Jalanmu - Buat Akun</title>
        ...
        <div class="w-full max-w-[430px] md:max-w-[1000px] bg-white rounded-3xl border border-gray-100 shadow-xl overflow-hidden p-6 md:p-10 form-shadow transition-all duration-300">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 items-start">
                ...
                <div class="md:col-span-5 flex flex-col gap-6">
                    <!-- Banner Card (Mulai Petualanganmu) -->
                    <div class="relative w-full h-[180px] md:h-[240px] rounded-2xl overflow-hidden group">
                        <img src="{{ asset('images/mulai_petualanganmu.png') }}" alt="Mulai Petualanganmu" class="w-full h-full object-cover group-hover:scale-105 transition duration-500">
                        <!-- Gradient Overlay -->
                        <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent"></div>
                        <!-- Overlay Text -->
                        <div class="absolute bottom-4 left-4 right-4">
                            <h2 class="text-white text-xl md:text-2xl font-bold tracking-wide">Mulai Petualanganmu!</h2>
                        </div>
                    </div>

                    <!-- Greeting Card (Halo, Teman Pelajar) -->
                    <div class="bg-[#E6FFFA] rounded-2xl p-5 border border-[#B2F5EA] flex gap-3">
                        ...
                        <div>
                            <h3 class="text-[#007A66] font-bold text-base mb-1">Halo, Teman Pelajar!</h3>
                            <p class="text-[#007A66] text-xs md:text-sm leading-relaxed">
                                Yuk, buat akun dulu untuk mulai eksplorasi minat dan bakatmu. Hanya butuh beberapa menit kok!
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="nisn" name="nisn" placeholder="10 Digit Nomor Induk Siswa" value="{{ old('nisn') }}" maxlength="10" required
                                        class="w-full pl-11 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent text-sm transition">
                                </div>
                                <p class="text-[10px] text-gray-400 italic">Tanyakan ke Guru jika kamu tidak ingat NISN-mu.</p>
                                @error('nisn')
                                    <p class="text-[11px] text-red-500 mt-0.5">{{ $message }}</p>
                                @enderror
                            </div>
