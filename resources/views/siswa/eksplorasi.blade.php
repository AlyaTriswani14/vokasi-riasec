...
<body class="bg-[#f8fafc] font-sans text-gray-800 min-h-screen flex flex-col relative pb-24">
    ...
    @php
        ...
        // Rekomendasi jurusan SMK (dipakai kalau siswa SMP) - 128 jurusan resmi SMK, bisa multi-tipe RIASEC
        $rekomJurusan = [
            'r' => [
        ...
        @else
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    @foreach(array_slice($isSmk ? $rekomSkill[$tipeDominan] : $rekomJurusan[$tipeDominan], 0, 3) as $item)
                        @if($isSmk)
